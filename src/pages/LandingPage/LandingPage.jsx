    ...
    <div className='w-[100vw] h-[100vh] bg-[url("~/assets/bg-landing-page.jpg")] bg-contain bg-no-repeat bg-right-bottom flex flex-col justify-between px-10 py-8 animate-fadeIn'>
      ...
      <div className="w-[60%]">
        <div className="mb-8">
          ...
          <button className='bg-gradient-to-l from-mainColor2-800 to-mainColor2-100 text-white text-lg font-semibold uppercase px-8 py-3 rounded-full animate-fadeInTop hover:scale-90 hover:duration-300 hover:ease-in-out transition-all' onClick={() => navigate('/login')}>Mua sắm ngay!</button>
        </div>
      </div>
