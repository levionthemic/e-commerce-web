...
function UserInfo() {
  ...
  return (
    <Container disableGutters maxWidth='xl'>
      ...
      <Box className="inner-wrap-user-info" sx={{
        display: 'flex',
        alignItems: 'center',
        bgcolor: 'white',
        borderRadius: '10px',
        ...
        <Box className="inner-left-content" sx={{ width: '55%', p: '0 10px' }}>
          <Spin spinning={loading} tip="Đang cập nhật...">
            <Typography variant='h5' mb={4}>Thông tin cá nhân</Typography>
        ...
        <Box className="inner-right-content" sx={{ width: '45%', p: '15px 10px', borderLeft: '1px solid #ddd' }}>
