      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <ul className='flex items-center gap-8 text-white text-sm'>
            <li className='py-2 px-4 hover:text-mainColor1-400 hover:bg-white cursor-pointer transition-all hover:ease-in-out hover:duration-300'><Link to={'/buyer'}>Trang chủ</Link></li>
